...
while True:
    ...
    for face_encoding in face_encodings:
        ...
        if distance < confidence_threshold:
            ...
            new_entry = pd.DataFrame({'Name': ['Rahul'], 'Date': [date_str], 'Time': [time_str]})
    ...
    if recognition_count >= 5:
        ...
        df.to_excel('recognized_faces_me.xlsx', index=False)
...
if not df.empty:
    df.to_excel('attendance_me.xlsx', index=False)
